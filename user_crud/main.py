...
from user_crud.models.user import db  # Importamos la base de datos desde el módulo 'user'

from repositories.user_repository import UserRepository
from models.product import Product  # Solo importas el modelo Product, no es necesario importar db otra vez

from repositories.product_repository import ProductRepository

from controllers.user_controller import create_api as create_user_api  # Importamos la función que crea las rutas de la API para usuarios
from controllers.product_controller import create_api as create_product_api  # Importamos la función que crea las rutas de la API para productos
